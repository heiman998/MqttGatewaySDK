...
#define NODE_INFO_TYPE_AI1SW_STRING 					"Slight1_"	// 1路智能零火开关
#define NODE_INFO_TYPE_AI2SW_STRING					"Slight2_"	// 2路智能零火开关
#define NODE_INFO_TYPE_AI3SW_STRING					"Slight3_"	// 3路智能零火开关
#define NODE_INFO_TYPE_ZB_IR_TRANSPONDER_STRING		"IrTrans_"	// 红外转发
#define NODE_INFO_TYPE_RELAY_CONTROL_STRING			"Rlctrol_"	// 继电器盒子

#define NODE_INFO_TYPE_CUSTOM_RGB_AREA_STRING		"Cutrgb4_"	//客户定制四区灯控系统


#define NODE_INFO_TYPE_MAGNET_DOOR_STRING			"WDoor_"	// 门磁

#define NODE_INFO_TYPE_WATER_SENSOR_STRING 			"Water_"	//水浸
#define NODE_INFO_TYPE_PIR_SENSOR_STRING				"Pir_"	// 人体红外
#define NODE_INFO_TYPE_SMOKE_SENSOR_STRING			"Smoke_"	//烟雾探测器
#define NODE_INFO_TYPE_TEMP_HUM_SENSOR_STRING		"THP_"	//温湿度
#define NODE_INFO_TYPE_GAS_SENSOR_STRING	        		"Gas_"	//可燃气体传感器	
#define NODE_INFO_TYPE_WARNING_DEV_STRING			"Siren_"	//声光警号
#define NODE_INFO_TYPE_CO_SENSOR_STRING				 "CO_"	//CO 传感器
#define NODE_INFO_TYPE_ILLUMINATION_STRING 			"Illumin_"	//光照度传感器
#define NODE_INFO_TYPE_AIR_QUALITY_STRING				"Airaction_"	//空气质量传感器
#define NODE_INFO_TYPE_THERMOSTAT_STRING 			"Thermost_"	//温控器
#define NODE_INFO_TYPE_VIBRATION_STRING				"Vibration_"	//震动传感器

#define NODE_INFO_TYPE_SOS_STRING						"Eb_"	//紧急按钮
#define NODE_INFO_TYPE_REMOTE_CONTROL_STRING		"Rc_"	//安防遥控器
#define NODE_INFO_TYPE_AI_SOCKET_USB_STRING		      "Uplug_"	//USB智能插座
#define NODE_INFO_TYPE_AI_SOCKET_MEASURE_STRING		"SPlug_"	//计量智能插座	
...
#define NODE_INFO_TYPE_AI1SW 					02	// 1路智能零火开关
#define NODE_INFO_TYPE_AI2SW					03	// 2路智能零火开关
#define NODE_INFO_TYPE_AI3SW					04	// 3路智能零火开关
#define NODE_INFO_TYPE_ZB_IR_TRANSPONDER		05	// 红外转发
#define NODE_INFO_TYPE_RELAY_CONTROL			06	// 继电器盒子

#define NODE_INFO_TYPE_CUSTOM_RGB_AREA		10	//客户定制四区灯控系统


#define NODE_INFO_TYPE_MAGNET_DOOR			17	// 门磁

#define NODE_INFO_TYPE_WATER_SENSOR 			18	//水浸
#define NODE_INFO_TYPE_PIR_SENSOR				19	// 人体红外
#define NODE_INFO_TYPE_SMOKE_SENSOR			20	//烟雾探测器
#define NODE_INFO_TYPE_TEMP_HUM_SENSOR		21	//温湿度
#define NODE_INFO_TYPE_GAS_SENSOR	        		22	//可燃气体传感器	
#define NODE_INFO_TYPE_WARNING_DEV			23	//声光警号
#define NODE_INFO_TYPE_CO_SENSOR				24	//CO 传感器
#define NODE_INFO_TYPE_ILLUMINATION 			25	//光照度传感器
#define NODE_INFO_TYPE_AIR_QUALITY				26	//空气质量传感器
#define NODE_INFO_TYPE_THERMOSTAT 			27	//温控器
#define NODE_INFO_TYPE_VIBRATION				28	//震动传感器

#define NODE_INFO_TYPE_SOS						49	//紧急按钮
#define NODE_INFO_TYPE_REMOTE_CONTROL		50	//安防遥控器
#define NODE_INFO_TYPE_AI_SOCKET_USB		       67	//USB智能插座
#define NODE_INFO_TYPE_AI_SOCKET_MEASURE		68	//计量智能插座
