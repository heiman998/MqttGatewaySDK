...
/**
 * @file qcom_iot_mqtt_interface.h
 * @brief Interface definition for MQTT client.
 */

#ifndef QCOM_IOT_SDK_SRC_IOT_MQTT_INTERFACE_H_
#define QCOM_IOT_SDK_SRC_IOT_MQTT_INTERFACE_H_
 ...
 *
 */
typedef A_INT32 (*iot_message_handler)(MQTTCallbackParams params);
 ...
 */
MQTT_ERROR_T qcom_mqtt_connect(MQTTConnectParams *pParams);
 ...
 */
MQTT_ERROR_T qcom_mqtt_publish(MQTTPublishParams *pParams);
 ...
 */
MQTT_ERROR_T qcom_mqtt_subscribe(MQTTSubscribeParams *pParams);
 ...
 */
MQTT_ERROR_T qcom_mqtt_unsubscribe(A_CHAR *pTopic);
 ...
 * @return An IoT Error Type defining successful/failed connection
 */
MQTT_ERROR_T qcom_mqtt_attempt_reconnect(void);
 ...
 */
MQTT_ERROR_T qcom_mqtt_disconnect(void);
 ...
 */
MQTT_ERROR_T qcom_mqtt_yield(A_INT32 timeout);
 ...
 */
A_BOOL qcom_is_mqtt_connected(void);
 ...
 */
A_BOOL qcom_is_autoreconnect_enabled(void);
 ...
 *
 * @return MQTT_ERROR_T Type defining successful/failed API call
 */
MQTT_ERROR_T qcom_mqtt_autoreconnect_set_status(A_BOOL value);

typedef MQTT_ERROR_T (*pConnectFunc_t)(MQTTConnectParams *pParams);
typedef MQTT_ERROR_T (*pPublishFunc_t)(MQTTPublishParams *pParams);
typedef MQTT_ERROR_T (*pSubscribeFunc_t)(MQTTSubscribeParams *pParams);
typedef MQTT_ERROR_T (*pUnsubscribeFunc_t)(A_CHAR *pTopic);
typedef MQTT_ERROR_T (*pDisconnectFunc_t)(void);
typedef MQTT_ERROR_T (*pYieldFunc_t)(A_INT32 timeout);
typedef A_BOOL (*pIsConnectedFunc_t)(void);
typedef A_BOOL (*pIsAutoReconnectEnabledFunc_t)(void);
typedef MQTT_ERROR_T (*pReconnectFunc_t)();
typedef MQTT_ERROR_T (*pSetAutoReconnectStatusFunc_t)(A_BOOL);
/**
 ...
 *
 */
void qcom_mqtt_init(MQTTClient_t *pClient);


#endif /* QCOM_IOT_SDK_SRC_IOT_MQTT_INTERFACE_H_ */
