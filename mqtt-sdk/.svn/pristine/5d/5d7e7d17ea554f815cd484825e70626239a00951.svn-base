...
/*
	A global memory to store the current SG secret. As the Ruby platform has no TIE extensions,
	RAM memory is being used (instead of a custom register) to hold the SG secret
*/
THREAD_DECLARE ULONG  g_StackGhost_Cookie;
