...
/*! \public
 * @brief MQTT Error enum
 *
 * Enumeration of return values from the IoT_* functions within the SDK.
 */
typedef enum {
	/*MQTT connection is disconnected manually*/
	MQTT_MANUALLY_DISCONNECTED = 2,
...
#define IoT_Error_t MQTT_ERROR_T 
#endif /* QCOM_IOT_SDK_SRC_IOT_ERROR_H_ */
